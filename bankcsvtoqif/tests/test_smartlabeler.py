...
class TestSmartLabeler(unittest.TestCase):
    def setUp(self):
        self.transaction = Transaction(datetime(2015, 5, 1), 'RentXYZ234 3848267', 'memo', 500, 0, 'Imbalance-EUR')
    ...
    def test_run_replacements(self):
        ...
        transactions = [
            Transaction(datetime(2015, 5, 1), 'no123 3848267', 'memo', 500, 0, 'Imbalance-EUR'),
            Transaction(datetime(2015, 5, 2), 'RentXYZ 3848267', 'memo2', 0, 500, 'Imbalance-EUR'),
            Transaction(datetime(2015, 5, 3), 'foobarbar', 'memo3', 500, 0, 'Imbalance-EUR'),
        ]
